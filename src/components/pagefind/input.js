import El from "./element-builder";
...
export class Input {
    constructor(opts = {}) {
        ...
        this.runInitialSearch = opts.runInitialSearch ?? false;
    ...
    register(instance) {
        ...
        // Override behavior: trigger a search with null on page load so we start with some results
        if (this.runInitialSearch) {
            (async () => {
